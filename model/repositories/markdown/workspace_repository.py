...
class MarkdownRepository(MongoRepository):
    ...
    def find(self, query: dict):
        super(MarkdownRepository, self).find(self.__inject_restriction__(query))

    def find_one(self, query: dict):
        super(MarkdownRepository, self).find_one(self.__inject_restriction__(query))

    def delete(self, id):
        super(MarkdownRepository, self).delete_one(self.__inject_restriction__({"id": id}))
