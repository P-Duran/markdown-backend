...
class PageRepository(MongoRepository):
    ...
    def find(self, query: dict):
        super(PageRepository, self).find(self.__inject_restriction__(query))

    def find_one(self, query: dict):
        super(PageRepository, self).find_one(self.__inject_restriction__(query))

    def delete(self, id):
        super(PageRepository, self).delete_one(self.__inject_restriction__({"id": id}))
